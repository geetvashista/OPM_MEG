...
x_min, x_max = temp_train[:, 0].min() - 1, temp_train[:, 0].max() + 1
y_min, y_max = temp_train[:, 1].min() - 1, temp_train[:, 1].max() + 1
...
plt.scatter(temp_train[:, 0], temp_train[:, 1], c=y_train, cmap=plt.cm.coolwarm)
