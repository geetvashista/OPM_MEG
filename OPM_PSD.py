...
def plot(participant):
    ...
    run_1 = get_mean_psd(f'/home/sahib/Documents/OPM_MEG/data/run_1/sub-00{participant}_run-001_VE_1_40_Hz_Z.mat_array.npy')
    run_2 = get_mean_psd(f'/home/sahib/Documents/OPM_MEG/data/run_2/sub-00{participant}_run-002_VE_1_40_Hz_Z.mat_array.npy')
