...
def setup_dependencies():    # Change as desired
    input_dir = r'D:\Geet\OPM_MEG\Data\run_1'     # The directory containing files of interest
    output_dir = r'D:\Geet\OPM_MEG\Data\Windows_run_1'    # The output directory
    ...
    return input_dir, output_dir, fs, target_fb, new_shape, band, saving
...
def main():
    input_dir, output_dir, fs, target_fb, new_shape, band, saving = setup_dependencies()
    ...
    if saving:
        np.save(output_dir + 'Windowed' + band, np.stack(output_data, axis=0))
